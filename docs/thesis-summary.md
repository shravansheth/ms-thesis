...
The thesis implements a two-pass out-of-tree MLIR system that detects the partition-by-endpoint
...
Full cross-platform analysis and the three-cost-regime framework are in
`thesis-reference/benchmarks.md` and `docs/benchmark-*.md`.
...
| `docs/benchmark-rpi3b.md` | RPi 3B (A53) benchmark analysis |
| `docs/benchmark-rpi4b.md` | RPi 4B (A72) benchmark analysis |
| `docs/benchmark-rpi5.md` | RPi 5 (A76) benchmark analysis |
| `docs/benchmark-cross-platform.md` | Cross-platform comparison |
| `thesis-reference/benchmarks.md` | Full benchmark reference and thesis framework |
