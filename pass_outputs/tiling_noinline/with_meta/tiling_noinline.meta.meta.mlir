...
module {
  ...
  func.func @tiling_caller(%arg0: memref<4096xf32>, %arg1: index, %arg2: index) {
    ...
    call @tile_stencil.__alias_meta_0(%subview, %subview_0, %arg2) {no_inline} : (memref<?xf32, strided<[1], offset: ?>>, memref<?xf32, strided<[1], offset: ?>>, index) -> ()
    return
  }
  func.func @tile_stencil.__alias_meta_0(%arg0: memref<?xf32, strided<[1], offset: ?>>, %arg1: memref<?xf32, strided<[1], offset: ?>>, %arg2: index) attributes {no_inline} {
