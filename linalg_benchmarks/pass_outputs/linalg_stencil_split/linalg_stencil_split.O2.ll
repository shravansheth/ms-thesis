; ModuleID = 'linalg_benchmarks/pass_outputs/linalg_stencil_split/linalg_stencil_split.ll'
...
12:                                               ; preds = %.lr.ph, %12
  ...
  store float 1.000000e+00, ptr %14, align 4, !noalias !1
...
17:                                               ; preds = %.lr.ph3, %17
  ...
  %20 = load float, ptr %19, align 4, !alias.scope !1
  %21 = getelementptr inbounds nuw float, ptr %11, i64 %18
  %22 = load float, ptr %21, align 4, !noalias !1
  %23 = fadd float %20, %22
  %24 = fadd float %23, 1.000000e+00
  store float %24, ptr %21, align 4, !noalias !1
