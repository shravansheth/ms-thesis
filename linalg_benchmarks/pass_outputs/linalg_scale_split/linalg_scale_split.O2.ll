; ModuleID = 'linalg_benchmarks/pass_outputs/linalg_scale_split/linalg_scale_split.ll'
source_filename = "LLVMDialectModule"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite)
define void @linalg_scale_split(ptr readnone captures(none) %0, ptr captures(none) initializes((0, 4)) %1, i64 %2, i64 %3, i64 %4, i64 %5) local_unnamed_addr #0 {
  %7 = sub i64 2048, %5
...
10:                                               ; preds = %.lr.ph, %10
  %11 = phi i64 [ 0, %.lr.ph ], [ %15, %10 ]
  %12 = getelementptr inbounds nuw float, ptr %9, i64 %11
  %13 = load float, ptr %12, align 4, !noalias !1
