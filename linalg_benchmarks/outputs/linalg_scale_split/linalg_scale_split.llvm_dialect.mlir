module {
  llvm.func @linalg_scale_split(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: i64) {
    ...
    %12 = llvm.getelementptr inbounds|nuw %11[%7] : (!llvm.ptr, i64) -> !llvm.ptr, f32
  ...
  ^bb2:  // pred: ^bb1
    ...
    %16 = llvm.getelementptr inbounds|nuw %15[%7] : (!llvm.ptr, i64) -> !llvm.ptr, f32
