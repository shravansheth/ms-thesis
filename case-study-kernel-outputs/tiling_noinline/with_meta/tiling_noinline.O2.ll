; ModuleID = '/Volumes/ShravsSSD/ms-thesis-copy/microbench_outputs/tiling_noinline/with_meta/tiling_noinline.ll'
...
define void @tiling_caller(ptr readnone captures(none) %0, ptr captures(none) %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6) local_unnamed_addr #0 {
  %8 = mul i64 %6, %5
  %9 = add i64 %8, %6
  tail call void @tile_stencil.__alias_meta_0(ptr poison, ptr %1, i64 %8, i64 poison, i64 poison, ptr poison, ptr %1, i64 %9, i64 poison, i64 poison, i64 %6) #1
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite)
define void @tile_stencil.__alias_meta_0(ptr readnone captures(none) %0, ptr readonly captures(none) %1, i64 %2, i64 %3, i64 %4, ptr readnone captures(none) %5, ptr writeonly captures(none) %6, i64 %7, i64 %8, i64 %9, i64 %10) local_unnamed_addr #0 {
  %12 = icmp sgt i64 %10, 0
  br i1 %12, label %.lr.ph, label %._crit_edge
