module {
  llvm.func @dse_blocked_alias(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: !llvm.ptr, %arg6: !llvm.ptr, %arg7: i64, %arg8: i64, %arg9: i64) {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %19 = llvm.getelementptr inbounds|nuw %18[%16] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %15, %19 : f32, !llvm.ptr
    %20 = llvm.extractvalue %5[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %21 = llvm.getelementptr inbounds|nuw %20[%16] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    ...
    %25 = llvm.getelementptr inbounds|nuw %24[%16] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %23, %25 : f32, !llvm.ptr
    %26 = llvm.add %16, %13 : i64
    llvm.br ^bb1(%26 : i64)
  ^bb3:  // pred: ^bb1
    llvm.return
  }
