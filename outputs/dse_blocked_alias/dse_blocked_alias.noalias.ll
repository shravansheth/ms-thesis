...
; Oracle: noalias on all aligned-ptr args (%1 for A, %6 for B).
; Encodes: caller guarantees %A and %B are distinct allocations
; (e.g., via memref.distinct_objects or provably non-aliasing call sites).
; With noalias, DSE can eliminate the dead init-store and GVN can simplify the B load.
define void @dse_blocked_alias(ptr noalias %0, ptr noalias %1, i64 %2, i64 %3, i64 %4, ptr noalias %5, ptr noalias %6, i64 %7, i64 %8, i64 %9) {
