module {
  ...
  llvm.func @subview_hoist_static() {
    ...
    %20 = llvm.getelementptr inbounds|nuw %19[%1] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %3, %20 : f32, !llvm.ptr
    llvm.br ^bb1(%0 : i64)
  ...
  ^bb2:  // pred: ^bb1
    ...
    %24 = llvm.getelementptr inbounds|nuw %23[%1] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    ...
    %29 = llvm.fadd %28, %25 : f32
    %30 = llvm.add %21, %2 : i64
    %31 = llvm.extractvalue %16[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %32 = llvm.getelementptr inbounds|nuw %31[%30] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %29, %32 : f32, !llvm.ptr
    %33 = llvm.add %21, %1 : i64
    llvm.br ^bb1(%33 : i64)
  ^bb3:  // pred: ^bb1
    %34 = llvm.extractvalue %16[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
