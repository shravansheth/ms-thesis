; ModuleID = '/Volumes/ShravsSSD/ms-thesis-copy/microbench_outputs/subview_noalias/with_meta/subview_noalias.ll'
...
define void @caller() local_unnamed_addr #3 {
  ...
  tail call void @kernel.__alias_meta_0(ptr nonnull poison, ptr nonnull %1, i64 0, i64 poison, i64 poison, ptr nonnull poison, ptr nonnull %1, i64 512, i64 poison, i64 poison) #4
  tail call void @free(ptr %1)
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite)
define void @kernel.__alias_meta_0(ptr readnone captures(none) %0, ptr readonly captures(none) %1, i64 %2, i64 %3, i64 %4, ptr readnone captures(none) %5, ptr writeonly captures(none) %6, i64 %7, i64 %8, i64 %9) local_unnamed_addr #2 {
  %11 = getelementptr float, ptr %1, i64 %2
  %12 = load float, ptr %11, align 4, !alias.scope !1
