; ModuleID = '/Volumes/ShravsSSD/ms-thesis-copy/microbench_outputs/adjacent_tiles/with_meta/adjacent_tiles.ll'
...
.lr.ph:                                           ; preds = %7
  %9 = mul i64 %6, %5
  %10 = getelementptr float, ptr %1, i64 %9
...
13:                                               ; preds = %.lr.ph, %13
  ...
  %17 = fadd float %11, %16
  %18 = getelementptr inbounds nuw float, ptr %12, i64 %14
