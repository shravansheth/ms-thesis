...
module {
  ...
  llvm.func @caller(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: !llvm.ptr, %arg6: !llvm.ptr, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: i64) {
    ...
    %99 = llvm.getelementptr inbounds|nuw %98[%15] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %13, %99 {alias_scopes = [#alias_scope]} : f32, !llvm.ptr
    %100 = llvm.extractvalue %78[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %101 = llvm.getelementptr inbounds|nuw %100[%15] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %12, %101 {alias_scopes = [#alias_scope1]} : f32, !llvm.ptr
    ...
    llvm.call @stencil_a.__alias_meta_0(%102, %103, %104, %105, %106, %107, %108, %109, %110, %111, %14) {no_inline} : (!llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64, i64) -> ()
    ...
    llvm.call @stencil_b.__alias_meta_1(%112, %113, %114, %115, %116, %117, %118, %119, %120, %121, %58) {no_inline} : (!llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64, i64) -> ()
    llvm.return
  }
  llvm.func @stencil_a.__alias_meta_0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: !llvm.ptr, %arg6: !llvm.ptr, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: i64) {
    %0 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %1 = llvm.insertvalue %arg5, %0[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %2 = llvm.insertvalue %arg6, %1[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %3 = llvm.insertvalue %arg7, %2[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
  ...
  llvm.func @stencil_b.__alias_meta_1(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: !llvm.ptr, %arg6: !llvm.ptr, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: i64) {
    %0 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %1 = llvm.insertvalue %arg5, %0[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %2 = llvm.insertvalue %arg6, %1[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %3 = llvm.insertvalue %arg7, %2[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
  ...
  ^bb2:  // pred: ^bb1
    ...
    %18 = llvm.getelementptr %16[%17] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %19 = llvm.getelementptr inbounds|nuw %18[%13] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %20 = llvm.load %19 {alias_scopes = [#alias_scope1]} : !llvm.ptr -> f32
    %21 = llvm.extractvalue %11[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %22 = llvm.extractvalue %11[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %23 = llvm.getelementptr %21[%22] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %24 = llvm.getelementptr inbounds|nuw %23[%14] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %25 = llvm.load %24 {alias_scopes = [#alias_scope1]} : !llvm.ptr -> f32
    %26 = llvm.fadd %25, %20 : f32
    %27 = llvm.extractvalue %5[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %28 = llvm.extractvalue %5[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %29 = llvm.getelementptr %27[%28] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %30 = llvm.getelementptr inbounds|nuw %29[%14] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %26, %30 {noalias_scopes = [#alias_scope1]} : f32, !llvm.ptr
    %31 = llvm.add %14, %12 : i64
    llvm.br ^bb1(%31 : i64)
  ^bb3:  // pred: ^bb1
    llvm.return
