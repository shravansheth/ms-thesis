...
define void @caller(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, ptr %5, ptr %6, i64 %7, i64 %8, i64 %9, i64 %10) {
  ...
  %83 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %21, 1
  %84 = getelementptr inbounds nuw float, ptr %83, i64 0
  store float 1.000000e+00, ptr %84, align 4
  %85 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %16, 1
  ...
  call void @stencil_a(ptr %87, ptr %88, i64 %89, i64 %90, i64 %91, ptr %92, ptr %93, i64 %94, i64 %95, i64 %96, i64 512) #0
  ...
  call void @stencil_b(ptr %97, ptr %98, i64 %99, i64 %100, i64 %101, ptr %102, ptr %103, i64 %104, i64 %105, i64 %106, i64 %52) #0
  ret void
}
