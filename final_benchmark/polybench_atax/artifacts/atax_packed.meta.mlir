...
module @"/Volumes/ShravsSSD/ms-thesis-copy/benchmark_exploration/source_diffs/polybench_atax_clangir/atax_packed.c" attributes {llvm.target_triple = "arm64-apple-macosx26.0.0"} {
  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8, strided<[1], offset: ?>>, strided<[1], offset: ?>>) -> i32 attributes {no_inline} {
    ...
    %subview_11 = memref.subview %37[0] [%38] [1] : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
    call @kernel_atax.__alias_meta_0(%33, %34, %reinterpret_cast_8, %cast_10, %subview, %subview_11) : (i32, i32, memref<124xf32>, memref<?xf32, strided<[1], offset: ?>>, memref<?xf32, strided<[1], offset: ?>>, memref<?xf32, strided<[1], offset: ?>>) -> ()
    memref.alloca_scope  {
      ...
      %52 = scf.if %51 -> (i1) {
        ...
        %dim_14 = memref.dim %53, %c0 : memref<?xmemref<?xi8, strided<[1], offset: ?>>, strided<[1], offset: ?>>
        %subview_15 = memref.subview %53[0] [%dim_14] [1] : memref<?xmemref<?xi8, strided<[1], offset: ?>>, strided<[1], offset: ?>> to memref<?xmemref<?xi8, strided<[1], offset: ?>>, strided<[1], offset: ?>>
        %54 = memref.load %subview_15[%c0] : memref<?xmemref<?xi8, strided<[1], offset: ?>>, strided<[1], offset: ?>>
        %55 = memref.get_global @".str" : memref<1xi8>
        %reinterpret_cast_16 = memref.reinterpret_cast %55 to offset: [0], sizes: [1], strides: [1] : memref<1xi8> to memref<1xi8, strided<[1]>>
        %cast_17 = memref.cast %reinterpret_cast_16 : memref<1xi8, strided<[1]>> to memref<?xi8, strided<[1], offset: ?>>
        %56 = func.call @strcmp(%54, %cast_17) : (memref<?xi8, strided<[1], offset: ?>>, memref<?xi8, strided<[1], offset: ?>>) -> i32
      ...
      scf.if %52 {
        ...
        %dim_14 = memref.dim %54, %c0 : memref<?xf32, strided<[1], offset: ?>>
        %57 = arith.subi %dim_14, %56 : index
        %subview_15 = memref.subview %54[%56] [%57] [1] : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        func.call @print_array(%53, %subview_15) : (i32, memref<?xf32, strided<[1], offset: ?>>) -> ()
      }
    }
    ...
    %intptr_12 = memref.extract_aligned_pointer_as_index %43 : memref<124xf32> -> index
    %44 = arith.index_castui %intptr_12 : index to i64
    %45 = llvm.inttoptr %44 : i64 to !llvm.ptr
    call @free(%45) : (!llvm.ptr) -> ()
    %46 = memref.load %alloca_6[%c0] : memref<1xmemref<?xf32, strided<[1], offset: ?>>>
    %intptr_13 = memref.extract_aligned_pointer_as_index %46 : memref<?xf32, strided<[1], offset: ?>> -> index
    %47 = arith.index_castui %intptr_13 : index to i64
  ...
  func.func private @kernel_atax.__alias_meta_0(%arg0: i32, %arg1: i32, %arg2: memref<124xf32>, %arg3: memref<?xf32, strided<[1], offset: ?>>, %arg4: memref<?xf32, strided<[1], offset: ?>>, %arg5: memref<?xf32, strided<[1], offset: ?>>) attributes {no_inline} {
    %c124 = arith.constant 124 : index
    %cst = arith.constant 0.000000e+00 : f32
    %c1_i32 = arith.constant 1 : i32
    %c0_i32 = arith.constant 0 : i32
