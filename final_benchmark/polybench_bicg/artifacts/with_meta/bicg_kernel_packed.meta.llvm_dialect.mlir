...
module @"/Volumes/ShravsSSD/ms-thesis-copy/benchmark_exploration/source_diffs/polybench_bicg_clangir/bicg_kernel_packed.c" attributes {llvm.target_triple = "arm64-apple-macosx26.0.0"} {
  ...
  llvm.func @run_bicg_packed(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: !llvm.ptr, %arg6: !llvm.ptr, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: !llvm.ptr, %arg11: !llvm.ptr, %arg12: i64, %arg13: i64, %arg14: i64, %arg15: !llvm.ptr, %arg16: !llvm.ptr, %arg17: i64, %arg18: i64, %arg19: i64, %arg20: i32, %arg21: i32) {
    ...
    %142 = llvm.extractvalue %108[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %143 = llvm.extractvalue %108[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    ...
    %157 = llvm.insertvalue %149, %156[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %158 = llvm.insertvalue %109, %157[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %159 = llvm.mlir.constant(1 : index) : i64
    %160 = llvm.insertvalue %159, %158[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %161 = llvm.extractvalue %105[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %162 = llvm.extractvalue %105[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %163 = llvm.extractvalue %105[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %164 = llvm.extractvalue %105[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %165 = llvm.extractvalue %105[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %166 = llvm.extractvalue %160[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %167 = llvm.extractvalue %160[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %168 = llvm.extractvalue %160[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %169 = llvm.extractvalue %160[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %170 = llvm.extractvalue %160[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %171 = llvm.extractvalue %135[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %172 = llvm.extractvalue %135[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %173 = llvm.extractvalue %135[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %174 = llvm.extractvalue %135[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %175 = llvm.extractvalue %135[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %176 = llvm.extractvalue %138[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %177 = llvm.extractvalue %138[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %178 = llvm.extractvalue %138[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %179 = llvm.extractvalue %138[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %180 = llvm.extractvalue %138[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %181 = llvm.extractvalue %141[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %182 = llvm.extractvalue %141[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %183 = llvm.extractvalue %141[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %184 = llvm.extractvalue %141[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %185 = llvm.extractvalue %141[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @kernel_bicg.__alias_meta_0(%99, %102, %161, %162, %163, %164, %165, %166, %167, %168, %169, %170, %171, %172, %173, %174, %175, %176, %177, %178, %179, %180, %181, %182, %183, %184, %185) : (i32, i32, !llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64) -> ()
    llvm.return
  }
  llvm.func @kernel_bicg.__alias_meta_0(%arg0: i32, %arg1: i32, %arg2: !llvm.ptr, %arg3: !llvm.ptr, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: !llvm.ptr, %arg8: !llvm.ptr, %arg9: i64, %arg10: i64, %arg11: i64, %arg12: !llvm.ptr, %arg13: !llvm.ptr, %arg14: i64, %arg15: i64, %arg16: i64, %arg17: !llvm.ptr, %arg18: !llvm.ptr, %arg19: i64, %arg20: i64, %arg21: i64, %arg22: !llvm.ptr, %arg23: !llvm.ptr, %arg24: i64, %arg25: i64, %arg26: i64) {
    %0 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %1 = llvm.insertvalue %arg22, %0[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %2 = llvm.insertvalue %arg23, %1[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %3 = llvm.insertvalue %arg24, %2[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
  ...
  ^bb2:  // pred: ^bb1
    ...
    %155 = llvm.extractvalue %149[3] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %156 = llvm.alloca %154 x !llvm.array<1 x i64> : (i64) -> !llvm.ptr
    llvm.store %155, %156 : !llvm.array<1 x i64>, !llvm.ptr
    %157 = llvm.getelementptr %156[0, %33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1 x i64>
    %158 = llvm.load %157 : !llvm.ptr -> i64
    %159 = llvm.sub %158, %153 : i64
    %160 = llvm.extractvalue %149[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %161 = llvm.extractvalue %149[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    ...
    %167 = llvm.extractvalue %149[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %168 = llvm.extractvalue %149[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %169 = llvm.extractvalue %149[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %170 = llvm.add %167, %153 : i64
    %171 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %172 = llvm.extractvalue %166[0] : !llvm.struct<(ptr, ptr, i64)> 
    %173 = llvm.extractvalue %166[1] : !llvm.struct<(ptr, ptr, i64)> 
    %174 = llvm.insertvalue %172, %171[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %175 = llvm.insertvalue %173, %174[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %176 = llvm.insertvalue %170, %175[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %177 = llvm.insertvalue %159, %176[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %178 = llvm.mlir.constant(1 : index) : i64
    %179 = llvm.insertvalue %178, %177[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %180 = llvm.extractvalue %179[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %181 = llvm.extractvalue %179[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %182 = llvm.getelementptr %180[%181] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %183 = llvm.getelementptr inbounds|nuw %182[%33] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %31, %183 {alias_scopes = [#alias_scope]} : f32, !llvm.ptr
    %184 = llvm.extractvalue %113[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %185 = llvm.getelementptr inbounds|nuw %184[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %186 = llvm.load %185 : !llvm.ptr -> i32
    %187 = llvm.add %186, %30 : i32
    %188 = llvm.extractvalue %113[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %189 = llvm.getelementptr inbounds|nuw %188[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %187, %189 : i32, !llvm.ptr
    llvm.br ^bb1
  ^bb3:  // pred: ^bb1
    %190 = llvm.extractvalue %113[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %191 = llvm.getelementptr inbounds|nuw %190[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %32, %191 : i32, !llvm.ptr
    llvm.br ^bb4
  ^bb4:  // 2 preds: ^bb3, ^bb8
    %192 = llvm.extractvalue %113[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %193 = llvm.getelementptr inbounds|nuw %192[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %194 = llvm.load %193 : !llvm.ptr -> i32
    %195 = llvm.extractvalue %53[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %196 = llvm.getelementptr inbounds|nuw %195[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %197 = llvm.load %196 : !llvm.ptr -> i32
    %198 = llvm.icmp "slt" %194, %197 : i32
    llvm.cond_br %198, ^bb5, ^bb9
  ^bb5:  // pred: ^bb4
    %199 = llvm.extractvalue %83[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %200 = llvm.getelementptr inbounds|nuw %199[%33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %201 = llvm.load %200 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %202 = llvm.extractvalue %113[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %203 = llvm.getelementptr inbounds|nuw %202[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %204 = llvm.load %203 : !llvm.ptr -> i32
    %205 = llvm.sext %204 : i32 to i64
    %206 = llvm.mlir.constant(1 : index) : i64
    %207 = llvm.extractvalue %201[3] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %208 = llvm.alloca %206 x !llvm.array<1 x i64> : (i64) -> !llvm.ptr
    llvm.store %207, %208 : !llvm.array<1 x i64>, !llvm.ptr
    %209 = llvm.getelementptr %208[0, %33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1 x i64>
    %210 = llvm.load %209 : !llvm.ptr -> i64
    %211 = llvm.sub %210, %205 : i64
    %212 = llvm.extractvalue %201[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %213 = llvm.extractvalue %201[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %214 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64)>
    ...
    %219 = llvm.extractvalue %201[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %220 = llvm.extractvalue %201[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %221 = llvm.extractvalue %201[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %222 = llvm.add %219, %205 : i64
    %223 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %224 = llvm.extractvalue %218[0] : !llvm.struct<(ptr, ptr, i64)> 
    %225 = llvm.extractvalue %218[1] : !llvm.struct<(ptr, ptr, i64)> 
    %226 = llvm.insertvalue %224, %223[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %227 = llvm.insertvalue %225, %226[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %228 = llvm.insertvalue %222, %227[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %229 = llvm.insertvalue %211, %228[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %230 = llvm.mlir.constant(1 : index) : i64
    %231 = llvm.insertvalue %230, %229[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %232 = llvm.extractvalue %231[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %233 = llvm.extractvalue %231[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %234 = llvm.getelementptr %232[%233] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %235 = llvm.getelementptr inbounds|nuw %234[%33] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %31, %235 {noalias_scopes = [#alias_scope]} : f32, !llvm.ptr
    %236 = llvm.extractvalue %123[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %237 = llvm.getelementptr inbounds|nuw %236[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %32, %237 : i32, !llvm.ptr
    llvm.br ^bb6
  ^bb6:  // 2 preds: ^bb5, ^bb7
    %238 = llvm.extractvalue %123[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %239 = llvm.getelementptr inbounds|nuw %238[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %240 = llvm.load %239 : !llvm.ptr -> i32
    %241 = llvm.extractvalue %43[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %242 = llvm.getelementptr inbounds|nuw %241[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %243 = llvm.load %242 : !llvm.ptr -> i32
    %244 = llvm.icmp "slt" %240, %243 : i32
    llvm.cond_br %244, ^bb7, ^bb8
  ^bb7:  // pred: ^bb6
    %245 = llvm.extractvalue %73[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %246 = llvm.getelementptr inbounds|nuw %245[%33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %247 = llvm.load %246 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %248 = llvm.extractvalue %123[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %249 = llvm.getelementptr inbounds|nuw %248[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %250 = llvm.load %249 : !llvm.ptr -> i32
    %251 = llvm.sext %250 : i32 to i64
    %252 = llvm.mlir.constant(1 : index) : i64
    %253 = llvm.extractvalue %247[3] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %254 = llvm.alloca %252 x !llvm.array<1 x i64> : (i64) -> !llvm.ptr
    llvm.store %253, %254 : !llvm.array<1 x i64>, !llvm.ptr
    %255 = llvm.getelementptr %254[0, %33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1 x i64>
    %256 = llvm.load %255 : !llvm.ptr -> i64
    %257 = llvm.sub %256, %251 : i64
    %258 = llvm.extractvalue %247[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %259 = llvm.extractvalue %247[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %260 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64)>
    %261 = llvm.insertvalue %258, %260[0] : !llvm.struct<(ptr, ptr, i64)> 
    %262 = llvm.insertvalue %259, %261[1] : !llvm.struct<(ptr, ptr, i64)> 
    %263 = llvm.mlir.constant(0 : index) : i64
    %264 = llvm.insertvalue %263, %262[2] : !llvm.struct<(ptr, ptr, i64)> 
    %265 = llvm.extractvalue %247[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %266 = llvm.extractvalue %247[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %267 = llvm.extractvalue %247[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %268 = llvm.add %265, %251 : i64
    %269 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %270 = llvm.extractvalue %264[0] : !llvm.struct<(ptr, ptr, i64)> 
    %271 = llvm.extractvalue %264[1] : !llvm.struct<(ptr, ptr, i64)> 
    ...
    %274 = llvm.insertvalue %268, %273[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %275 = llvm.insertvalue %257, %274[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %276 = llvm.mlir.constant(1 : index) : i64
    %277 = llvm.insertvalue %276, %275[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %278 = llvm.extractvalue %277[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %279 = llvm.extractvalue %277[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %280 = llvm.getelementptr %278[%279] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %281 = llvm.getelementptr inbounds|nuw %280[%33] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %282 = llvm.load %281 {alias_scopes = [#alias_scope]} : !llvm.ptr -> f32
    %283 = llvm.extractvalue %103[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %284 = llvm.getelementptr inbounds|nuw %283[%33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %285 = llvm.load %284 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %286 = llvm.extractvalue %113[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %287 = llvm.getelementptr inbounds|nuw %286[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %288 = llvm.load %287 : !llvm.ptr -> i32
    %289 = llvm.sext %288 : i32 to i64
    %290 = llvm.extractvalue %285[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %291 = llvm.extractvalue %285[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %292 = llvm.getelementptr %290[%291] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %293 = llvm.getelementptr inbounds|nuw %292[%289] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %294 = llvm.load %293 : !llvm.ptr -> f32
    %295 = llvm.extractvalue %63[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %296 = llvm.getelementptr inbounds|nuw %295[%33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %297 = llvm.load %296 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %298 = llvm.add %289, %251 : i64
    %299 = llvm.extractvalue %297[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %300 = llvm.getelementptr inbounds|nuw %299[%298] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %301 = llvm.load %300 : !llvm.ptr -> f32
    %302 = llvm.fmul %294, %301 : f32
    %303 = llvm.fadd %282, %302 : f32
    %304 = llvm.extractvalue %277[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %305 = llvm.extractvalue %277[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %306 = llvm.getelementptr %304[%305] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %307 = llvm.getelementptr inbounds|nuw %306[%33] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %303, %307 {alias_scopes = [#alias_scope]} : f32, !llvm.ptr
    %308 = llvm.extractvalue %83[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %309 = llvm.getelementptr inbounds|nuw %308[%33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %310 = llvm.load %309 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %311 = llvm.extractvalue %113[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %312 = llvm.getelementptr inbounds|nuw %311[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %313 = llvm.load %312 : !llvm.ptr -> i32
    %314 = llvm.sext %313 : i32 to i64
    %315 = llvm.mlir.constant(1 : index) : i64
    %316 = llvm.extractvalue %310[3] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %317 = llvm.alloca %315 x !llvm.array<1 x i64> : (i64) -> !llvm.ptr
    llvm.store %316, %317 : !llvm.array<1 x i64>, !llvm.ptr
    %318 = llvm.getelementptr %317[0, %33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1 x i64>
    %319 = llvm.load %318 : !llvm.ptr -> i64
    %320 = llvm.sub %319, %314 : i64
    %321 = llvm.extractvalue %310[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    ...
    %324 = llvm.insertvalue %321, %323[0] : !llvm.struct<(ptr, ptr, i64)> 
    %325 = llvm.insertvalue %322, %324[1] : !llvm.struct<(ptr, ptr, i64)> 
    %326 = llvm.mlir.constant(0 : index) : i64
    %327 = llvm.insertvalue %326, %325[2] : !llvm.struct<(ptr, ptr, i64)> 
    %328 = llvm.extractvalue %310[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %329 = llvm.extractvalue %310[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %330 = llvm.extractvalue %310[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %331 = llvm.add %328, %314 : i64
    %332 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %333 = llvm.extractvalue %327[0] : !llvm.struct<(ptr, ptr, i64)> 
    %334 = llvm.extractvalue %327[1] : !llvm.struct<(ptr, ptr, i64)> 
    %335 = llvm.insertvalue %333, %332[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %336 = llvm.insertvalue %334, %335[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %337 = llvm.insertvalue %331, %336[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %338 = llvm.insertvalue %320, %337[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %339 = llvm.mlir.constant(1 : index) : i64
    %340 = llvm.insertvalue %339, %338[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %341 = llvm.extractvalue %340[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %342 = llvm.extractvalue %340[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %343 = llvm.getelementptr %341[%342] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %344 = llvm.getelementptr inbounds|nuw %343[%33] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %345 = llvm.load %344 {noalias_scopes = [#alias_scope]} : !llvm.ptr -> f32
    %346 = llvm.extractvalue %63[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %347 = llvm.getelementptr inbounds|nuw %346[%33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %348 = llvm.load %347 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %349 = llvm.extractvalue %123[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %350 = llvm.getelementptr inbounds|nuw %349[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %351 = llvm.load %350 : !llvm.ptr -> i32
    %352 = llvm.sext %351 : i32 to i64
    %353 = llvm.add %314, %352 : i64
    %354 = llvm.extractvalue %348[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %355 = llvm.getelementptr inbounds|nuw %354[%353] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %356 = llvm.load %355 : !llvm.ptr -> f32
    %357 = llvm.extractvalue %93[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %358 = llvm.getelementptr inbounds|nuw %357[%33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %359 = llvm.load %358 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %360 = llvm.extractvalue %359[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %361 = llvm.extractvalue %359[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %362 = llvm.getelementptr %360[%361] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %363 = llvm.getelementptr inbounds|nuw %362[%352] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %364 = llvm.load %363 : !llvm.ptr -> f32
    %365 = llvm.fmul %356, %364 : f32
    %366 = llvm.fadd %345, %365 : f32
    %367 = llvm.extractvalue %340[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %368 = llvm.extractvalue %340[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %369 = llvm.getelementptr %367[%368] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %370 = llvm.getelementptr inbounds|nuw %369[%33] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %366, %370 {noalias_scopes = [#alias_scope]} : f32, !llvm.ptr
    %371 = llvm.extractvalue %123[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %372 = llvm.getelementptr inbounds|nuw %371[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %373 = llvm.load %372 : !llvm.ptr -> i32
    %374 = llvm.add %373, %30 : i32
    %375 = llvm.extractvalue %123[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %376 = llvm.getelementptr inbounds|nuw %375[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %374, %376 : i32, !llvm.ptr
    llvm.br ^bb6
  ^bb8:  // pred: ^bb6
    %377 = llvm.extractvalue %113[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %378 = llvm.getelementptr inbounds|nuw %377[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %379 = llvm.load %378 : !llvm.ptr -> i32
    %380 = llvm.add %379, %30 : i32
    %381 = llvm.extractvalue %113[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %382 = llvm.getelementptr inbounds|nuw %381[%33] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %380, %382 : i32, !llvm.ptr
    llvm.br ^bb4
  ^bb9:  // pred: ^bb4
    llvm.return
  }
