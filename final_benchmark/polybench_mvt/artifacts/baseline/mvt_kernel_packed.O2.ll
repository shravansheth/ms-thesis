; ModuleID = 'benchmark_exploration/source_diffs/polybench_mvt_clangir/baseline/mvt_kernel_packed.ll'
...
define void @run_mvt_packed(ptr readnone captures(none) %0, ptr readonly captures(none) %1, i64 %2, i64 %3, i64 %4, ptr readnone captures(none) %5, ptr captures(none) %6, i64 %7, i64 %8, i64 %9, ptr readnone captures(none) %10, ptr readonly captures(none) %11, i64 %12, i64 %13, i64 %14, ptr readnone captures(none) %15, ptr captures(none) %16, i64 %17, i64 %18, i64 %19, i32 %20) local_unnamed_addr #0 {
  ...
  br i1 %22, label %.preheader134.lr.ph.i, label %kernel_mvt.exit
...
.lr.ph.i:                                         ; preds = %._crit_edge.i, %.preheader134.lr.ph.i
  ...
  %26 = getelementptr inbounds nuw float, ptr %24, i64 %indvars.iv144.i
  %27 = getelementptr float, ptr %1, i64 %indvars.iv144.i
  %.promoted.i = load float, ptr %26, align 4
  br label %36
...
36:                                               ; preds = %36, %.lr.ph.i
  ...
  %40 = getelementptr inbounds nuw float, ptr %25, i64 %indvars.iv.i
...
vector.body:                                      ; preds = %.lr.ph138.i, %vector.body
  ...
  %wide.load = load <4 x float>, ptr %45, align 4, !alias.scope !23
  %wide.load97 = load <4 x float>, ptr %46, align 4, !alias.scope !23
  %47 = getelementptr inbounds nuw float, ptr %29, i64 %index
  %48 = getelementptr inbounds nuw i8, ptr %47, i64 16
  %wide.load98 = load <4 x float>, ptr %47, align 4, !alias.scope !26
  %wide.load99 = load <4 x float>, ptr %48, align 4, !alias.scope !26
  ...
  br i1 %53, label %middle.block, label %vector.body, !llvm.loop !28

middle.block:                                     ; preds = %vector.body
  store float %52, ptr %44, align 4, !alias.scope !29, !noalias !31
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond153.not.i, label %._crit_edge139.i, label %scalar.ph, !llvm.loop !32

._crit_edge139.i:                                 ; preds = %scalar.ph, %middle.block
  %indvars.iv.next155.i = add nuw nsw i64 %indvars.iv154.i, 1
  %exitcond158.not.i = icmp eq i64 %indvars.iv.next155.i, %23
  br i1 %exitcond158.not.i, label %kernel_mvt.exit, label %.lr.ph138.i

kernel_mvt.exit:                                  ; preds = %._crit_edge139.i, %21
  ret void
}
