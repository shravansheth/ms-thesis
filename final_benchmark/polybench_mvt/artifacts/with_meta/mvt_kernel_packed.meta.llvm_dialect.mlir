...
module @"/Volumes/ShravsSSD/ms-thesis-copy/benchmark_exploration/source_diffs/polybench_mvt_clangir/mvt_kernel_packed.c" attributes {llvm.target_triple = "arm64-apple-macosx26.0.0"} {
  ...
  llvm.func @run_mvt_packed(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: !llvm.ptr, %arg6: !llvm.ptr, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: !llvm.ptr, %arg11: !llvm.ptr, %arg12: i64, %arg13: i64, %arg14: i64, %arg15: !llvm.ptr, %arg16: !llvm.ptr, %arg17: i64, %arg18: i64, %arg19: i64, %arg20: i32) {
    ...
    %129 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64)>
    %130 = llvm.insertvalue %127, %129[0] : !llvm.struct<(ptr, ptr, i64)> 
    %131 = llvm.insertvalue %128, %130[1] : !llvm.struct<(ptr, ptr, i64)> 
    %132 = llvm.mlir.constant(0 : index) : i64
    %133 = llvm.insertvalue %132, %131[2] : !llvm.struct<(ptr, ptr, i64)> 
    %134 = llvm.extractvalue %90[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %135 = llvm.extractvalue %90[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %136 = llvm.extractvalue %90[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %137 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %138 = llvm.extractvalue %133[0] : !llvm.struct<(ptr, ptr, i64)> 
    %139 = llvm.extractvalue %133[1] : !llvm.struct<(ptr, ptr, i64)> 
    %140 = llvm.insertvalue %138, %137[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %141 = llvm.insertvalue %139, %140[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %142 = llvm.insertvalue %134, %141[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %143 = llvm.insertvalue %94, %142[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %144 = llvm.mlir.constant(1 : index) : i64
    %145 = llvm.insertvalue %144, %143[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %146 = llvm.extractvalue %145[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %147 = llvm.extractvalue %145[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %148 = llvm.extractvalue %145[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %149 = llvm.extractvalue %145[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %150 = llvm.extractvalue %145[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %151 = llvm.extractvalue %93[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %152 = llvm.extractvalue %93[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %153 = llvm.extractvalue %93[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %154 = llvm.extractvalue %93[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %155 = llvm.extractvalue %93[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %156 = llvm.extractvalue %120[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %157 = llvm.extractvalue %120[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %158 = llvm.extractvalue %120[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %159 = llvm.extractvalue %120[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %160 = llvm.extractvalue %120[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %161 = llvm.extractvalue %123[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %162 = llvm.extractvalue %123[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %163 = llvm.extractvalue %123[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %164 = llvm.extractvalue %123[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %165 = llvm.extractvalue %123[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %166 = llvm.extractvalue %126[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %167 = llvm.extractvalue %126[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %168 = llvm.extractvalue %126[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %169 = llvm.extractvalue %126[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %170 = llvm.extractvalue %126[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @kernel_mvt.__alias_meta_0(%87, %146, %147, %148, %149, %150, %151, %152, %153, %154, %155, %156, %157, %158, %159, %160, %161, %162, %163, %164, %165, %166, %167, %168, %169, %170) : (i32, !llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64, !llvm.ptr, !llvm.ptr, i64, i64, i64) -> ()
    llvm.return
  }
  llvm.func @kernel_mvt.__alias_meta_0(%arg0: i32, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: !llvm.ptr, %arg7: !llvm.ptr, %arg8: i64, %arg9: i64, %arg10: i64, %arg11: !llvm.ptr, %arg12: !llvm.ptr, %arg13: i64, %arg14: i64, %arg15: i64, %arg16: !llvm.ptr, %arg17: !llvm.ptr, %arg18: i64, %arg19: i64, %arg20: i64, %arg21: !llvm.ptr, %arg22: !llvm.ptr, %arg23: i64, %arg24: i64, %arg25: i64) {
    %0 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %1 = llvm.insertvalue %arg21, %0[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %2 = llvm.insertvalue %arg22, %1[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %3 = llvm.insertvalue %arg23, %2[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
  ...
  ^bb4:  // pred: ^bb3
    ...
    %151 = llvm.extractvalue %145[3] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %152 = llvm.alloca %150 x !llvm.array<1 x i64> : (i64) -> !llvm.ptr
    llvm.store %151, %152 : !llvm.array<1 x i64>, !llvm.ptr
    %153 = llvm.getelementptr %152[0, %32] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1 x i64>
    %154 = llvm.load %153 : !llvm.ptr -> i64
    %155 = llvm.sub %154, %149 : i64
    %156 = llvm.extractvalue %145[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %157 = llvm.extractvalue %145[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    ...
    %163 = llvm.extractvalue %145[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %164 = llvm.extractvalue %145[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %165 = llvm.extractvalue %145[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %166 = llvm.add %163, %149 : i64
    %167 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %168 = llvm.extractvalue %162[0] : !llvm.struct<(ptr, ptr, i64)> 
    %169 = llvm.extractvalue %162[1] : !llvm.struct<(ptr, ptr, i64)> 
    %170 = llvm.insertvalue %168, %167[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %171 = llvm.insertvalue %169, %170[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %172 = llvm.insertvalue %166, %171[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    ...
    %177 = llvm.extractvalue %175[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %178 = llvm.getelementptr %176[%177] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %179 = llvm.getelementptr inbounds|nuw %178[%32] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %180 = llvm.load %179 {alias_scopes = [#alias_scope]} : !llvm.ptr -> f32
    %181 = llvm.extractvalue %92[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %182 = llvm.getelementptr inbounds|nuw %181[%32] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    ...
    %188 = llvm.add %149, %187 : i64
    %189 = llvm.extractvalue %183[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %190 = llvm.getelementptr inbounds|nuw %189[%188] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %191 = llvm.load %190 : !llvm.ptr -> f32
    %192 = llvm.extractvalue %72[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %193 = llvm.getelementptr inbounds|nuw %192[%32] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %194 = llvm.load %193 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %195 = llvm.mlir.constant(1 : index) : i64
    %196 = llvm.extractvalue %194[3] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %197 = llvm.alloca %195 x !llvm.array<1 x i64> : (i64) -> !llvm.ptr
    llvm.store %196, %197 : !llvm.array<1 x i64>, !llvm.ptr
    %198 = llvm.getelementptr %197[0, %32] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1 x i64>
    %199 = llvm.load %198 : !llvm.ptr -> i64
    %200 = llvm.sub %199, %187 : i64
    %201 = llvm.extractvalue %194[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %202 = llvm.extractvalue %194[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %203 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64)>
    %204 = llvm.insertvalue %201, %203[0] : !llvm.struct<(ptr, ptr, i64)> 
    %205 = llvm.insertvalue %202, %204[1] : !llvm.struct<(ptr, ptr, i64)> 
    %206 = llvm.mlir.constant(0 : index) : i64
    %207 = llvm.insertvalue %206, %205[2] : !llvm.struct<(ptr, ptr, i64)> 
    %208 = llvm.extractvalue %194[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %209 = llvm.extractvalue %194[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %210 = llvm.extractvalue %194[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %211 = llvm.add %208, %187 : i64
    %212 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %213 = llvm.extractvalue %207[0] : !llvm.struct<(ptr, ptr, i64)> 
    %214 = llvm.extractvalue %207[1] : !llvm.struct<(ptr, ptr, i64)> 
    %215 = llvm.insertvalue %213, %212[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %216 = llvm.insertvalue %214, %215[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %217 = llvm.insertvalue %211, %216[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %218 = llvm.insertvalue %200, %217[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %219 = llvm.mlir.constant(1 : index) : i64
    %220 = llvm.insertvalue %219, %218[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %221 = llvm.extractvalue %220[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %222 = llvm.extractvalue %220[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %223 = llvm.getelementptr %221[%222] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %224 = llvm.getelementptr inbounds|nuw %223[%32] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %225 = llvm.load %224 {noalias_scopes = [#alias_scope]} : !llvm.ptr -> f32
    %226 = llvm.fmul %191, %225 : f32
    %227 = llvm.fadd %180, %226 : f32
    %228 = llvm.extractvalue %175[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %229 = llvm.extractvalue %175[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %230 = llvm.getelementptr %228[%229] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %231 = llvm.getelementptr inbounds|nuw %230[%32] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %227, %231 {alias_scopes = [#alias_scope]} : f32, !llvm.ptr
    %232 = llvm.extractvalue %112[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %233 = llvm.getelementptr inbounds|nuw %232[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %234 = llvm.load %233 : !llvm.ptr -> i32
    %235 = llvm.add %234, %30 : i32
    %236 = llvm.extractvalue %112[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %237 = llvm.getelementptr inbounds|nuw %236[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %235, %237 : i32, !llvm.ptr
    llvm.br ^bb3
  ^bb5:  // pred: ^bb3
    %238 = llvm.extractvalue %102[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %239 = llvm.getelementptr inbounds|nuw %238[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %240 = llvm.load %239 : !llvm.ptr -> i32
    %241 = llvm.add %240, %30 : i32
    %242 = llvm.extractvalue %102[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %243 = llvm.getelementptr inbounds|nuw %242[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %241, %243 : i32, !llvm.ptr
    llvm.br ^bb1
  ^bb6:  // pred: ^bb1
    %244 = llvm.extractvalue %102[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %245 = llvm.getelementptr inbounds|nuw %244[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %31, %245 : i32, !llvm.ptr
    llvm.br ^bb7
  ^bb7:  // 2 preds: ^bb6, ^bb11
    %246 = llvm.extractvalue %102[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %247 = llvm.getelementptr inbounds|nuw %246[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %248 = llvm.load %247 : !llvm.ptr -> i32
    %249 = llvm.extractvalue %42[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %250 = llvm.getelementptr inbounds|nuw %249[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %251 = llvm.load %250 : !llvm.ptr -> i32
    %252 = llvm.icmp "slt" %248, %251 : i32
    llvm.cond_br %252, ^bb8, ^bb12
  ^bb8:  // pred: ^bb7
    %253 = llvm.extractvalue %112[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %254 = llvm.getelementptr inbounds|nuw %253[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %31, %254 : i32, !llvm.ptr
    llvm.br ^bb9
  ^bb9:  // 2 preds: ^bb8, ^bb10
    %255 = llvm.extractvalue %112[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %256 = llvm.getelementptr inbounds|nuw %255[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %257 = llvm.load %256 : !llvm.ptr -> i32
    %258 = llvm.extractvalue %42[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %259 = llvm.getelementptr inbounds|nuw %258[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %260 = llvm.load %259 : !llvm.ptr -> i32
    %261 = llvm.icmp "slt" %257, %260 : i32
    llvm.cond_br %261, ^bb10, ^bb11
  ^bb10:  // pred: ^bb9
    %262 = llvm.extractvalue %62[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %263 = llvm.getelementptr inbounds|nuw %262[%32] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %264 = llvm.load %263 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %265 = llvm.extractvalue %102[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %266 = llvm.getelementptr inbounds|nuw %265[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %267 = llvm.load %266 : !llvm.ptr -> i32
    %268 = llvm.sext %267 : i32 to i64
    %269 = llvm.extractvalue %264[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %270 = llvm.extractvalue %264[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %271 = llvm.getelementptr %269[%270] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %272 = llvm.getelementptr inbounds|nuw %271[%268] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %273 = llvm.load %272 : !llvm.ptr -> f32
    %274 = llvm.extractvalue %92[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %275 = llvm.getelementptr inbounds|nuw %274[%32] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %276 = llvm.load %275 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %277 = llvm.extractvalue %112[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %278 = llvm.getelementptr inbounds|nuw %277[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %279 = llvm.load %278 : !llvm.ptr -> i32
    %280 = llvm.sext %279 : i32 to i64
    %281 = llvm.add %280, %268 : i64
    %282 = llvm.extractvalue %276[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %283 = llvm.getelementptr inbounds|nuw %282[%281] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %284 = llvm.load %283 : !llvm.ptr -> f32
    %285 = llvm.extractvalue %82[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %286 = llvm.getelementptr inbounds|nuw %285[%32] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %287 = llvm.load %286 : !llvm.ptr -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %288 = llvm.extractvalue %287[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %289 = llvm.extractvalue %287[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %290 = llvm.getelementptr %288[%289] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %291 = llvm.getelementptr inbounds|nuw %290[%280] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %292 = llvm.load %291 : !llvm.ptr -> f32
    %293 = llvm.fmul %284, %292 : f32
    %294 = llvm.fadd %273, %293 : f32
    %295 = llvm.extractvalue %264[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %296 = llvm.extractvalue %264[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %297 = llvm.getelementptr %295[%296] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %298 = llvm.getelementptr inbounds|nuw %297[%268] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %294, %298 : f32, !llvm.ptr
    %299 = llvm.extractvalue %112[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %300 = llvm.getelementptr inbounds|nuw %299[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %301 = llvm.load %300 : !llvm.ptr -> i32
    %302 = llvm.add %301, %30 : i32
    %303 = llvm.extractvalue %112[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %304 = llvm.getelementptr inbounds|nuw %303[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %302, %304 : i32, !llvm.ptr
    llvm.br ^bb9
  ^bb11:  // pred: ^bb9
    %305 = llvm.extractvalue %102[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %306 = llvm.getelementptr inbounds|nuw %305[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %307 = llvm.load %306 : !llvm.ptr -> i32
    %308 = llvm.add %307, %30 : i32
    %309 = llvm.extractvalue %102[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %310 = llvm.getelementptr inbounds|nuw %309[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
